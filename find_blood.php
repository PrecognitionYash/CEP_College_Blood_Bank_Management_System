...
<body style="background: linear-gradient(45deg, #cfedf5 20%, #d595b9 60%, #e5eff2 20%);">
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-9 mb-3">Find Blood</h1>
...
<?php if(isset($_POST['search'])){
  ...
  $result=mysqli_query($conn,$sql) or die("query faild.");
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item rounded" ><br>
      <div class="card" style="width:300px">
          <img class="card-img-top" src="image\Card_img.jpg" alt="Card image" style="width:100%;height:300px">
          <div class="card-body">
